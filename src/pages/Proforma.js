...
import './Proforma.css';
import { db, obtenerNumeroProforma } from '../firebase/firebase'; 
...
const Proforma = () => {
  ...
  return (
    <div className="proforma-wrapper">
      ...
      {numeroProforma && (
        <div id="proformaContent" ref={proformaContentRef}> {/* Añadimos el id y ref aquí */}
          <h2>N° Proforma: {numeroProforma}</h2>
          <section className="proforma-info">
            <div className="factura-detalle">
              <p><strong>N° Proforma:</strong> {numeroProforma}</p>
          ...
          <div className="proforma-actions">
            <button onClick={agregarReparacion} disabled={!camposHabilitados}>+ Agregar Reparación</button>
          </div>
